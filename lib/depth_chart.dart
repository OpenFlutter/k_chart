...
class DepthChart extends StatefulWidget {
  ...
  DepthChart(this.bids, this.asks, {this.fixedLength = 2});
...
//    canvas.drawColor(Colors.black, BlendMode.color);
  ...
  void drawText(Canvas canvas) {
    ...
    var endText = mSellData.last.price.toStringAsFixed(fixedLength ?? 2);
  ...
  void drawSelectView(Canvas canvas, int index, bool isLeft) {
    ...
    //画底部
    TextPainter priceTP = getTextPainter(entity.price.toStringAsFixed(fixedLength ?? 2));
    priceTP.layout();
    double left;
